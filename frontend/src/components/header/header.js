...
const SearchResult = [
  {
    ...
    image: test,
    type: "Space",
    text: "Success and Happiness",
    quorum: "(q/success-and-happiness-)"
  },
  {
    id: 2,
    image: test,
    type: "Space",
    text: "Ask about Investments",
    quorum: "(q/ask-about-investments)"
  }
];
...
class Header extends Component {
  ...
  componentDidMount() {
    document.addEventListener("click", this.toggleAccountMenu);
    ...
    axios
      ...
      .then(res => {
        ...
        this.setState({ myid: res.data.myid });
        this.setState({
          menuitems: [
            {
              text: "Profile",
              link: `/profileother/${this.state.myid}`
            },
            {
              text: "Blogs",
              link: "/"
  ...
  componentWillUnmount() {
    console.log(456);
    document.removeEventListener("click", this.toggleAccountMenu);
  }
  ...
  toggleAccountMenu = event => {
    if (this.wrapperRef && this.wrapperRef.contains(event.target)) {
      document.getElementsByClassName("account-menu-wrapper")[0].style.display =
        "";
    }
    if (this.wrapperRef && !this.wrapperRef.contains(event.target)) {
      document.getElementsByClassName("account-menu-wrapper")[0].style.display =
  ...
  render() {
    let spans = [];
    HeaderSpanItems.forEach(item => {
      spans.push(
        <HeaderSpan key={item.name} path={this.props.match.path} item={item} />
      );
    });

    let accountitems = [];
    this.state.menuitems.forEach(item => {
      accountitems.push(<AccountMenuItem key={item.text} item={item} />);
    });
    return (
        ...
        <div className="header-inner">
          <div className="header-logo">
            <a href="/" style={{ backgroundImage: `url(${logo})` }}>
              <span style={{ display: "none" }}>Quora</span>
            </a>
          </div>
          <div className="header-content">
            <div className="header-nav">{spans}</div>
            <div className="header-right">
              ...
              <div className="ask-bar">
                <div className="Selector selector-input">
                  ...
                  />
                  <span onClick={this.handleSearch} title="Search">
                    <i className="material-icons enter_arrow">arrow_forward</i>
                  </span>
                  <span
                ...
                <span>
                  <div className="SiteHeaderNavItem">
                    <div
                      ...
                      style={{ display: "none" }}
                    >
                      <div className="account-menu-contents">
                        <div className="AccountMenuContents">
                          {accountitems}
                    ...
                    <a className="nav-item-link" ref={this.setWrapperRef}>
                      <span className="photo-wrapper">
                        <img src={avatar} width="26" height="26" alt="avatar" />
                      </span>
                    </a>
                  </div>
                </span>
              ...
              <div>
                <a href="/question" className="askQuestionbtn">
...
const SearchBar = props => {
  ...
  SearchResult.forEach(result => {
    results.push(<SelectorResult key={result.id} result={result} />);
  });
  ...
  return (
    <div className="ask-bar">
      ...
      <div className="selector-results-wrapper" style={{ display: "none" }}>
        <div className="results-wrapper">
          <div className="results">
            <ul className="SelectorResults">
              <li className="selector-result">
                <div>
                  <span className="selection-icon">
                    <img src={s1} width="20" height="20" alt="Search" />
                  </span>
                  <span className="selector-result-type">Search: </span>
                  <span className="selector-matched-term">z</span>
                </div>
              </li>
              {results}
              <li className="selector-result ask_new_question">
                <div className="ask-question">
                  <Link to="/question">Add New Question</Link>
                  {/* <a href="/question" className="ask-question" /> */}
                </div>
              </li>
            </ul>
          </div>
...
const AccountMenuItem = props => {
  return (
    <ul className="main-menu">
      <li>
        <a href={props.item.link} className="AccountMenuItem">
          {props.item.text}
        </a>
      </li>
    </ul>
    ...
    <span>
      <div className="SiteHeaderNavItem">
        <a
          ...
          className={
            "nav-item-link" +
            (props.path === props.item.link ? " selected" : "")
          }
        >
          <div>
            <span className="ui-icon">
              ...
              >
                <g
                  stroke={props.path === props.item.link ? "#b92b2722" : "none"}
                  className="icon_svg-fill_as_stroke"
                  fillRule="nonzero"
                >
                  <path d={props.item.icon} />
                </g>
              </svg>
            </span>
          </div>
  ...
  return (
    <li className="selector-result">
      <div>
        ...
        <span className="selector-result-type">{props.result.type}: </span>
        <span className="rendered-text">{props.result.text}</span>
        <span className="quorum-text"> {props.result.quorum}</span>
      </div>
    </li>
  );
};
